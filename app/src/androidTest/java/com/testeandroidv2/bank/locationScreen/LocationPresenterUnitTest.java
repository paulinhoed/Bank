...
import com.amadeus.flightstatuslistview.BuildConfig;
import com.amadeus.flightstatuslistview.FlightModel;
...
public class HomePresenterUnitTest {
    ...
    public void verify_HomePresenter_getDaysDiff_is_CalcualtedCorrectly_ForPastTrips() {
        ...
        String ActualText = homePresenterOutputSpy.homeViewModelCopy.listOfFlights.get(0).noOfDaysToFly;
        Assert.assertEquals("When current date is 2016/10/12 & Flying Date is 2016/10/01 Then no of days should be 12", ExpectedText, ActualText);
